...
that amplifies ENAQT universally across 95--100\% of random configurations; and
...
design, and its near-universal ENAQT rate (95--100\%) reflects the fact that
almost any energy heterogeneity creates some contrast.
...
temperature-varied trajectories; relaxing the energy-budget constraint to
determine how optimal enhancement scales when $\sigma_\text{max}$ grows with
