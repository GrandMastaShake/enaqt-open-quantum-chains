...
$\gps = 1.57\Delta$, within the biological dephasing window, consistent
with the Lindblad prediction for this model class.
...
The ratio $\eta_\text{peak}/\eta_\text{zero}$ grows explosively
